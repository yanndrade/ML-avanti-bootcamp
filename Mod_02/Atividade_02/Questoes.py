...
# Selecionar uma coluna específica podemos utilizar a notação de colchetes [] ou a função .loc[] do pandas.
...
# 3. Utilizar algoritmos de imputação de dados, como o K-NN (K-nearest neighbors) ou o método de interpolação linear etc.